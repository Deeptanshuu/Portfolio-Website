...
export function Hero() {
  ...
  // Generate stars only for desktop devices
  const starPositions = useMemo(() => {
    // Skip star generation for mobile
    if (isMobile) return { positions: new Float32Array(0), colors: new Float32Array(0) }
  ...
  // Only rotate stars if they exist
  useFrame((state) => {
